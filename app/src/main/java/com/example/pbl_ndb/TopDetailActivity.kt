...
import kotlinx.android.synthetic.main.activity_top_detail.*
...
//    var textViewDesc = findViewById<TextView>(R.id.textViewDesc)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var adapter2 : TopDetailAdapter? = null
        var topList2 : ArrayList<ItemDAO>
        topList2 = generateItemData()
        //Log.d("exist", topList.toString())
        adapter2 = TopDetailAdapter(this, topList2)

        grid.adapter = adapter2
...
//            textViewName.setText(topDAO1.name.toString())
//            textViewPrice.setText(topDAO1.price.toString())
//            textViewDesc.setText(topDAO1.description.toString())
